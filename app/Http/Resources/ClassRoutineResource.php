...
class ClassRoutineResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            /**
             * The unique identifier for the class routine entry.
             * @var int $id
             * @example 1
             */
            'id' => $this->id,
            ...
            /**
             * The ID of the associated classroom.
            ...
            /**
             * The title of the associated classroom.
             * @var string|null $classroom_title
             * @example "Room 101"
             */
            'classroom_title' => $this->whenLoaded('classroom', fn() => $this->classroom->title),

            /**
             * The day of the week for the class (e.g., "Monday").
             * @var string $day
             * @example "Monday"
             */
            'day' => $this->day,
            ...
            /**
             * The status of the class routine entry (true for active, false for inactive).
             * @var bool $status
             * @example true
             */
