...
class ItemStockResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            /**
             * The unique identifier for the item stock record.
             * @var int $id
             * @example 1
             */
            'id' => $this->id,
            ...
            /**
             * The quantity of the item added to stock.
             * @var int $quantity
             * @example 50
             */
            ...
            /**
             * The status of the item stock (true for active, false for inactive).
             * @var bool $status
             * @example true
             */
