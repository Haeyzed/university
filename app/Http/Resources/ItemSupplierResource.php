...
class ItemSupplierResource extends JsonResource
{
    ...
    public function toArray(Request $request): array
    {
        return [
            /**
             * The unique identifier for the item supplier.
             * @var int $id
             * @example 1
             */
            'id' => $this->id,
             ...
             * @example "contact@officedepot.com"
             */
            'email' => $this->email,
             ...
             * @example "123 Business Park, City"
             */
            'address' => $this->address,

            /**
             * The status of the item supplier (true for active, false for inactive).
             * @var bool $status
             * @example true
             */
