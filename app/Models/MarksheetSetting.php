...
/**
 * @class MarksheetSetting
 * @brief Model for managing marksheet settings.
 *
 * This model represents the 'marksheet_settings' table, storing
 * configurations for generating student marksheets.
 *
 * @property int $id
