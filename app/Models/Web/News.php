...
/**
 * @class News
 * @brief Model for managing website news.
 *
 * This model represents the 'news' table, storing news articles
...
class News extends Model implements Auditable
{
    ...
    /**
     * Get the user who created the news article.
     *
     * @return BelongsTo
     */
    ...
    /**
     * Get the user who last updated the news article.
     *
     * @return BelongsTo
     */
    ...
    /**
     * Get the content associated with the news.
     *
     * @return MorphOne
     */
