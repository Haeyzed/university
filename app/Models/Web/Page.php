...
/**
 * @class Page
 * @brief Model for managing website pages.
 *
 * This model represents the 'pages' table, storing static
 * content for various pages on the website.
 *
 * @property int $id
