...
/**
 * @class Feature
 * @brief Model for managing website features.
 *
 * This model represents the 'features' table, storing information
 * about key features or highlights of the institution.
 *
 * @property int $id
...
class Feature extends Model implements Auditable
{
    ...
    /**
     * Get the user who created the feature.
     *
     * @return BelongsTo
     */
    ...
    /**
     * Get the user who last updated the feature.
     *
     * @return BelongsTo
     */
