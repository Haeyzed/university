...
/**
 * @class Slider
 * @brief Model for managing website sliders.
 *
 * This model represents the 'sliders' table, storing images
 * and content for the main website slider.
 *
 * @property int $id
