...
/**
 * @class Gallery
 * @brief Model for managing website galleries.
 *
 * This model represents the 'galleries' table, storing images
 * and descriptions for public display.
 *
 * @property int $id
...
class Gallery extends Model implements Auditable
{
    ...
    /**
     * Get the user who last updated the gallery item.
     *
     * @return BelongsTo
     */
